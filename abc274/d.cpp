...
int main() {
  ...
  vector<bool> dp_x(20100);
  vector<bool> dp_y(20100);
  vector<bool> tmp(20100);
  ...
  cout << (dp_x[DIFF + x] && dp_y[DIFF + y] ? "Yes" : "No") << '\n';
}
